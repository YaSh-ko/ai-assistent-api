...
Чтобы это было не «демо распознавания», а часть продукта **[Impulse](https://delez.tech)**, мы сохраняем результат как `Entry`:
...
Наш текущий этап в **[Impulse](https://delez.tech)** — рабочий и стабильный baseline. Следующие шаги, которые логично развивать:
